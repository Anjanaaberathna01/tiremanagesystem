<!-- Header -->
  <header class="flex justify-between items-center p-2 bg-[#0F1E36] shadow-md z-10">
    <div class="flex items-center space-x-3">
      <a href="{{ route('home') }}">
        <img src="{{ asset('assets/images/logo2.png') }}" class="h-[60px] sm:h-[80px]" alt="SLTMobitel Logo">
      </a>
    </div>
    @auth
    <div class="relative">
      ...
      <div id="profileMenu" class="absolute right-0 z-20 hidden w-56 mt-2 text-black border-2 border-blue-600 shadow-lg rounded-xl">
        <!-- Banner Section -->
