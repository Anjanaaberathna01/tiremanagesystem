<aside class="relative z-10 w-full p-4 bg-white shadow sm:w-64">
      ...
      <div class="relative z-10 flex flex-col mt-4 space-y-4 sm:mt-8 sm:items-center sm:space-y-6">
        ...
        <a href="{{ route('order.list') }}" class="block w-full text-center bg-yellow-600 text-white py-2 rounded-[10px] hover:bg-yellow-700 text-sm sm:text-base">Order Page</a>
