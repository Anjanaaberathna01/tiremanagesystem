    ...
    <div class="flex-1 overflow-y-auto p-4 sm:p-8 bg-[#999999]"
      ...
      <div class="bg-white rounded-[30px] shadow p-4 sm:p-6">
        ...
        <div class="flex flex-col justify-between mb-6 md:flex-row md:items-center">
          <h2 class="mb-4 text-xl font-extrabold text-blue-800 sm:text-2xl md:mb-0">Tire Dashboard</h2>
        ...
        <div class="overflow-x-auto">
          <input id="tireSearchInput" onkeyup="filterTable('tireTable', 'tireSearchInput')"
                 placeholder="Search by Tire Brand, Size..."
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      brandSelect.addEventListener('change', function() {
        ...
        .then(supplier => {
          ...
          if (supplier) supplierSelect.innerHTML = `<option value="${supplier.id}" selected>${supplier.name}</option>`;
          else supplierSelect.innerHTML = '<option value="" disabled selected>No supplier found</option>';
        });
      });
    });
  </script>
